...
//=========Question 1==================================
    ...
    //new test cases
	void TestQ1_newTest1(CuTest *tc) {

		CuAssertStrEquals(tc, "Olukemi", my_strcat("Olu","kemi"));
	}
	void TestQ1_newTest2(CuTest *tc) {

		CuAssertStrEquals(tc, "ComputerProgramming", my_strcat("Computer","Programming"));
	}
//===========================================================
//=================Question 2================================
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		//new test cases
		SUITE_ADD_TEST(suite, TestQ1_newTest1);
		SUITE_ADD_TEST(suite, TestQ1_newTest2);
